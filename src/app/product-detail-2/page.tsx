        ...
        <div className="flex mt-3 justify-around">
          {variants.map((variant, index) => (
            <div
              ...
              className={`relative flex-1 max-w-[75px] h-10 sm:h-11 rounded-xs border-2 cursor-pointer ${variantActive === index
                ? "border-primary-6000 dark:border-primary-500"
                : "border-transparent"
                }`}
            >
              <div
                className="absolute inset-0.5 rounded-xs overflow-hidden z-0 bg-cover"
                style={{
                  backgroundImage: `url(${
                    // @ts-ignore
        ...
        <div className="grid grid-cols-2 gap-2 mt-3">
          {allOfSizes.map((size, index) => {
            ...
            return (
              <div
                key={index}
                className={`relative h-10 sm:h-11 rounded-xs border flex items-center justify-center 
                text-xs sm:text-xs uppercase font-semibold select-none overflow-hidden z-0 ${sizeOutStock
          ...
          <div className="hidden sm:flex flex-col space-y-4 ">
            <div className="space-y-2.5">
              <div className="flex justify-between text-slate-600 dark:text-slate-300">
                <span className="flex">
                  <span>{`${PRICE.toFixed(2)}đ  `}</span>
                  <span className="mx-2">x</span>
                  <span>{`${qualitySelected} `}</span>
                </span>

                <span>{`${(PRICE * qualitySelected).toFixed(2)}đ`}</span>
              </div>
              <div className="flex justify-between text-slate-600 dark:text-slate-300">
      ...
      <div className="listingSection__wrap !space-y-6">
        <div>
          <h2 className="text-2xl md:text-3xl font-semibold">
            Giường Thiết Kế Bay Phong Cách Tinh Tế
          </h2>
    ...
    return (
      <div className="listingSection__wrap !border-b-0 !pb-0">
        ...
        <div className="prose prose-sm sm:prose dark:prose-invert sm:max-w-4xl">
          <p>
            Bàn làm việc đa năng nhỏ gọn BG_13 là giải pháp lý tưởng cho không gian làm việc có diện tích hạn chế. Với thiết kế thông minh và tiện ích, BG_13 cung cấp không gian làm việc hiệu quả mà không chiếm nhiều diện tích. Dù nhỏ gọn, sản phẩm vẫn được trang bị đầy đủ các tính năng cần thiết, bao gồm các ngăn và kệ lưu trữ, giúp bạn tổ chức công việc một cách ngăn nắp. Chất liệu chất lượng và độ bền cao đảm bảo rằng BG_13 sẽ phục vụ nhu cầu làm việc của bạn trong thời gian dài mà vẫn giữ được vẻ ngoài gọn gàng và hiện đại.
          </p>
          <p>
            Bàn làm việc đa năng nhỏ gọn BG_13 là giải pháp lý tưởng cho không gian làm việc có diện tích hạn chế.
          </p>
          <ul>
            <li>Viết thêm mô tả sản phẩm ở đây</li>
            <li>Viết thêm mô tả sản phẩm ở đây</li>
            <li>Viết thêm mô tả sản phẩm ở đây</li>
            <li>Viết thêm mô tả sản phẩm ở đây</li>
          </ul>
